...
export async function watch(zenReq) {
  ...
  if (zenReq.body.context.event === "/sale/saleCreate") {
    const properties = zenReq.body.args.bean.properties == null ? {} : zenReq.body.args.bean.properties;
    let comments = properties.hasOwnProperty('comments') ? properties.comments + '\n\n' : '';
