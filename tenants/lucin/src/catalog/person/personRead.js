...
export async function personRead(zenReq) {
  ...
  // Block access for users who are not granted to "/custom/lucin/pessoas/restrito" accessPoint
  // RSQL: city==null or city.state.country.codeA2==BR
  if (!await securityService.accessPointOpValidate("/custom/lucin/pessoas/restrito")) {
    customConditions.push({
      ...
      conditions: [
        ...
        {
          type: "simple",
          propertyName: "city.state.country.codeA2",
          op: "EQ",
          value: {
